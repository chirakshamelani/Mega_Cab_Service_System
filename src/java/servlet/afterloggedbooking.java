...
public class afterloggedbooking extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = dbconnection.getConnection()) {
            String query = "INSERT INTO booking (customer_id, pickup_location, destination, fare, status) VALUES (?, ?, ?, ?, ?)";
            ...
            stmt.setString(5, "Pending"); // Set status as "Pending" or as per your requirement
