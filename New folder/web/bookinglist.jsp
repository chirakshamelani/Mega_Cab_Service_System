    ...
    if (customerId == null) {
        ...
        try {
            ...
            stmt = conn.prepareStatement(
                "SELECT b.booking_id,b.vehicle_type, b.pickup_location, b.destination, b.fare, b.status, " +
            ...
            if (rs.next()) {
                ...
                out.println("<tr><th>Booking ID</th><th>Vehicle Type</th><th>Pickup Location</th><th>Destination</th><th>Fare</th><th>Status</th><th>Driver ID</th><th>Driver Name</th></tr>");
                do {
                    ...
                    out.println("<td>" + vehicle_type + "</td>");
